...
/** Styles */
import classes from './banner-cursor.module.less';
...
const BannerCursor: React.FC<MapStatePropsType> = (props) => {
    ...
    return (
        <svg className={classes.cursorReplacement} ref={$cursorReplacement} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="none">
