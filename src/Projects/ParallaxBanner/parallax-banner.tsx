        ...
        <div className={s.parallaxBanner}>
            ...
            <div className={s.contentText}>
                <p>Banner with a parallax effect. The style of the banner was inspired by Durer's medieval engravings, alchemy and other various mysticism. 
                    ...
                    graphic programs that I have worked with before or continue to work with. The internal Pentagon shows programming languages and IT technologies 
                    ...
                    are clouds that move depending on the position of the mouse. They represent cloud technologies so indispensable and essential in nowadayas. 
                    Behind the clouds, the sun and moon are motionless, meaning my work in IT from dawn to dusk. </p>
